# Первая AMA-сессия / Стейкинг + DeFi, как добиться баланса между ликвидностью и высокой доходностью?
...
***Дата проведения：2020/4/10***

**Задания:**
- Отправьте задание на выполнение в группу WeChat
...
Активные посетители страницы с активностью：57,534

Уникальные просмотры：14,128

Общее число участников в WeChat：10,718

Новые участники в группе в WeChat：1,800+

**Распределение наград:**

Общий призовой пул：4,000 BNC

Фактически распределенный пул：3,892.768 BNC

Дата распределения призов：2020/4/18

Примечание：оставшийся призовой пул BNC не был распределен по следующим причинам：(1) Не выполнены все задания (2) Не привязан кошелек BNC (3) Привязан неправильный кошелек
