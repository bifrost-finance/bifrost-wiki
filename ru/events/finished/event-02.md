# Hotbit × Bifrost Polka Ecosystem AMA: Нововведения в POS-майнинге
...
Активные посетители страницы с активностью：7,903

Уникальные посетители страницы с активностью：1,748

Новые подписчике в официальном аккаунте WeChat：145

**Распределение наград:**

Общий призовой пул: 1,000 BNC

Фактически распределенный пул：425.2078 BNC

Дата распределение призов：2020/6/6

Примечание：причины, по которым часть BNC не была распределена：(1) Не были выполнены условия активности (2) Не был привязан кошелек BNC


| Кошелек BNC                                      | Кол-во BNC |
| ------------------------------------------------ | ---------- |
