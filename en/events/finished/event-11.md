...
**Event Rules**
- If others open your bonus, you will get 50% of the amount taken as a reward, and there is no upper limit for the superimposed reward
- Each WeChat account can only open others' bonus once
- Unlimited number of bonus to others
- The bonus will be finally issued only if the event conditions are met
